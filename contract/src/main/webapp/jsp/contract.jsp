...
<head>
    ...
    <link rel="stylesheet" href="../plugin/pdfjs/web/viewer.css">
    ...
    <script src="../plugin/pdfjs/build/pdf.js"></script>
    <script>
        ...
        var pdfPath = "/pdf/" + unescape(params.pdf);
    </script>
    <script src="../plugin/pdfjs/web/viewer.js"></script>
</head>
...
<script>
    ...
    function initDrow() {
        ...
        $("#btn_submit").click(function () {
            ...
            $.showLoading("签名加载中");
            $.post("/signature", postObj, function (re) {
                if (re.code == 0) {
                    window.location.href = "/jsp/contract.jsp?pdf=" + encodeURIComponent(escape(re.data));
                } else {
                    $.alert(re.message);
                }
                $.hideLoading();
